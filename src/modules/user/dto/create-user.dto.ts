...
export class CreateUserDto {
  ...
  @Length(8, 20)
  @Matches(/^[a-z\d]{8,}$/, {
    message: "Username must be at least 8 characters long and contain only lowercase letters."
  })
  username: string;
  ...
  @Length(8, 20)
  @Matches(/^[a-z\d]{8,}$/, {
    message: "Password must be at least 8 characters long and contain only lowercase letters."
    ,
  })
  password: string;
